    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="ti-paint-bucket"></i> <span> System </span> </a>
                    <ul class="list-unstyled">
                        <li><a href="ui-checkbox-radio.html">Settings</a></li>
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="ti-light-bulb"></i>
                        <span class="label label-primary pull-right">6</span><span> Components </span> </a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="ti-bar-chart"></i><span
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="ti-crown"></i><span
