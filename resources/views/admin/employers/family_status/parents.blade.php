...
<div class="panel-body">
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('f_full_name') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('f_full_name', (isset($employer->father->f_full_name)? $employer->father->f_full_name : null), array('placeholder' => 'សូមបញ្ចូលគោត្តនៈនាមនិងនាម','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('f_fn_en') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('f_fn_en', (isset($employer->father->f_fn_en)? $employer->father->f_fn_en : null), array('placeholder' => 'សូមបញ្ចូលជាអក្សរឡាតាំង','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('f_nationality') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('f_nationality', (isset($employer->father->f_nationality)? $employer->father->f_nationality : null), array('placeholder' => 'សូមបញ្ចូលសញ្ជាតិ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('f_ethnic') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('f_ethnic', (isset($employer->father->f_ethnic)? $employer->father->f_ethnic : null), array('placeholder' => 'សូមបញ្ចូលជនជាតិ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group{!! $errors->has('f_address') ? ' has-error' : '' !!}">
            ...
            {!! Form::textarea('f_address', (isset($employer->father->f_address)? $employer->father->f_address : null), array('placeholder' => 'សូមបញ្ចូលអាសយដ្ឋាន','class' => 'form-control', 'rows'=>'3')) !!}
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group{!! $errors->has('f_job') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('f_job', (isset($employer->father->f_job)? $employer->father->f_job : null), array('placeholder' => 'សូមបញ្ចូលមុខរបរបច្ចុប្បន្ន','class' => 'form-control')) !!}
            @if($errors->has('f_job'))
                <span class="help-block">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group{!! $errors->has('f_department') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('f_department', (isset($employer->father->f_department)? $employer->father->f_department : null), array('placeholder' => 'សូមបញ្ចូលស្ថាប័នឬអង្គភាព','class' => 'form-control')) !!}
...
<div class="panel-body">
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('m_full_name') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('m_full_name', (isset($employer->mother->m_full_name)? $employer->mother->m_full_name : null), array('placeholder' => 'សូមបញ្ចូលគោត្តនៈនាមនិងនាម','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('m_fn_en') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('m_fn_en', (isset($employer->mother->m_fn_en)? $employer->mother->m_fn_en : null), array('placeholder' => 'សូមបញ្ចូលជាអក្សរឡាតាំង','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-2 col-md-2">
        ...
        {!! Form::select('m_status', (isset($employer->mother->m_status) ? (isset($employer->mother->m_status) ? $status : null) : $status), (isset($employer->mother->m_status) ? $employer->mother->m_status : null), array('placeholder' => '--ជ្រើសរើស--','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('m_nationality') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('m_nationality', (isset($employer->mother->m_nationality)? $employer->mother->m_nationality : null), array('placeholder' => 'សូមបញ្ចូលសញ្ជាតិ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('m_ethnic') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('m_ethnic', (isset($employer->mother->m_ethnic)? $employer->mother->m_ethnic : null), array('placeholder' => 'សូមបញ្ចូលជនជាតិ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group{!! $errors->has('m_address') ? ' has-error' : '' !!}">
            ...
            {!! Form::textarea('m_address', (isset($employer->mother->m_address)? $employer->mother->m_address : null), array('placeholder' => 'សូមបញ្ចូលអាសយដ្ឋាន','class' => 'form-control', 'rows'=>'3')) !!}
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group{!! $errors->has('m_job') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('m_job', (isset($employer->mother->m_job)? $employer->mother->m_job : null), array('placeholder' => 'សូមបញ្ចូលមុខរបរបច្ចុប្បន្ន','class' => 'form-control')) !!}
            @if($errors->has('m_job'))
                <span class="help-block">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group{!! $errors->has('m_department') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('m_department', (isset($employer->mother->m_department)? $employer->mother->m_department : null), array('placeholder' => 'សូមបញ្ចូលស្ថាប័នឬអង្គភាព','class' => 'form-control')) !!}
