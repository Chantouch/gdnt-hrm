...
<div class="panel-body">
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('sp_full_name') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_full_name', (isset($employer->spouse->sp_full_name)? $employer->spouse->sp_full_name : null), array('placeholder' => 'សូមបញ្ចូលគោត្តនៈនាមនិងនាម','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('sp_fn_en') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_fn_en', (isset($employer->spouse->sp_fn_en)? $employer->spouse->sp_fn_en : null), array('placeholder' => 'សូមបញ្ចូលជាអក្សរឡាតាំង','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-2 col-md-2">
        ...
        {!! Form::select('sp_status', (isset($employer->spouse->sp_status) ? (isset($employer->spouse->sp_status) ? $status : null) : $status), (isset($employer->spouse->sp_status) ? $employer->spouse->sp_status : null), array('placeholder' => '--សូមជ្រើសរើស--','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('sp_nationality') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_nationality', (isset($employer->spouse->sp_nationality)? $employer->spouse->sp_nationality : null), array('placeholder' => 'សូមបញ្ចូលសញ្ជាតិ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('sp_ethnic') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_ethnic', (isset($employer->spouse->sp_ethnic)? $employer->spouse->sp_ethnic : null), array('placeholder' => 'សូមបញ្ចូលជនជាតិ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group{!! $errors->has('sp_pob') ? ' has-error' : '' !!}">
            ...
            {!! Form::textarea('sp_pob', (isset($employer->spouse->sp_pob)? $employer->spouse->sp_pob : null), array('placeholder' => 'សូមបញ្ចូលថ្ងៃខែឆ្នាំកំណើត','class' => 'form-control', 'rows'=>'3')) !!}
    ...
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('sp_job') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_job', (isset($employer->spouse->sp_job)? $employer->spouse->sp_job : null), array('placeholder' => 'សូមបញ្ចូលមុខរបរបច្ចុប្បន្ន','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="form-group{!! $errors->has('sp_department') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_department', (isset($employer->spouse->sp_department)? $employer->spouse->sp_department : null), array('placeholder' => 'សូមបញ្ចូលស្ថានប័នឬអង្គភាព','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-2 col-md-2">
        ...
        {!! Form::select('sp_subsidy', (isset($employer->spouse->sp_subsidy) ? (isset($employer->spouse->sp_subsidy) ? $subsidy : null) : $subsidy), (isset($employer->spouse->sp_subsidy) ? $employer->spouse->sp_subsidy : null), array('placeholder' => '--ជ្រើសរើស--','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('sp_hand_phone') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_hand_phone', (isset($employer->spouse->sp_hand_phone)? $employer->spouse->sp_hand_phone : null), array('placeholder' => 'សូមបញ្ចូលទូរសព្ទដៃ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('sp_work_phone') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_work_phone', (isset($employer->spouse->sp_work_phone)? $employer->spouse->sp_work_phone : null), array('placeholder' => 'សូមបញ្ចូលទូរសព្ទកន្លែងធ្វើការ','class' => 'form-control')) !!}
    ...
    <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="form-group{!! $errors->has('sp_home_phone') ? ' has-error' : '' !!}">
            ...
            {!! Form::text('sp_home_phone', (isset($employer->spouse->sp_home_phone)? $employer->spouse->sp_home_phone : null), array('placeholder' => 'សូមបញ្ចូលទូរសព្ទនៅផ្ទះ','class' => 'form-control')) !!}
