<div class="panel panel-default">
    ...
    <div id="job-history" class="panel-collapse collapse">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="row">
                    ...
                    {{--//Remove last field--}}
                    <div class="col-xs-12 col-sm-2 col-md-2 {!! (Request::Segment(5) == 'edit') ? 'hidden' : '' !!}" id="public_div_remove">
                        <div class="form-group">
        ...
        {{--Private history job section--}}
        @include('admin.employers.private_job')
        {{--Private history job section--}}
