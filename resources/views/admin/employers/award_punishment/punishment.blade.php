                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group{!! $errors->has('published_date') ? ' has-error' : '' !!}">
                            ...
                            <div class="input-group">
                                {!! Form::text('pun_published_date[]', (isset($punishment->pun_published_date) ? $punishment->pun_published_date : null), array('placeholder' => 'Select your published date','class' => 'form-control  date_picker')) !!}
