...
@section('script_ready')
    ...
    jQuery('#cjs_last_date_promoted, #passport_expired_date, #dob, #id_card_expired, #start_date, #fsj_permanent_staff_date, #cjs_last_date_got_promoted, #acp_start_date, #fn_start_date').datepicker({
    autoclose: true,
    todayHighlight: true,
    format: 'yyyy-M-d',
    });

    jQuery('#nss_start_date, #nss_end_date, #ap_published_date, #el_start_date, #el_end_date, #whp_dob, #sp_dob, #m_dob, #f_dob, #sib_dob, #child_dob, #fn_end_date, #phj_start_date, #phj_end_date').datepicker({
    autoclose: true,
    todayHighlight: true,
    format: 'yyyy-M-d',
    });
